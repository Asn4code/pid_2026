...
=== "📖 Capítulo Teórico & Pseudocódigo"
    ...
    <div style="margin: 1.5em 0;" class="admonition info">
      ...
      <p>
        <a href="../../assets/capitulos/TC01_capitulo_v2.2.pdf" class="md-button md-button--primary" download>
          📥 Descargar Capítulo TC01 (PDF · v2.2)
        </a>
      </p>
...
=== "💻 Laboratorio & Descarga de Kit"
    ...
    <div style="margin: 1.5em 0;">
      <a href="../../assets/kits/kit_TC01.tar.gz" class="md-button md-button--primary" download>
        📥 Descargar Kit de Práctica (kit_TC01.tar.gz)
      </a>
    </div>
