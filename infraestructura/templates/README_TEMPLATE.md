...
| Fecha | {{FECHA}} |
| Asignatura | {{ASIGNATURA_DISPLAY}} |
| Módulo | {{MODULE}} |
| Sesión(es) | {{SESION}} |
| Tipo de sesión | {{TIPO_SESION}} |
| Resultados de guía | {{RESULTADOS}} |
| Evidencia | {{EVIDENCIA}} |
...
tar -xzf paquete/{{MODULE}}_starter_v0.1.0.tar.gz
cd {{MODULE}}_starter
```

### Google Colab

Abre el cuaderno `notebooks/{{MODULE}}_colab.ipynb` en Google Colab. El cuaderno descarga automáticamente el paquete starter.
