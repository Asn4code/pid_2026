...
tar -xzf paquete/BC10_starter_v0.1.0.tar.gz
cd BC10_starter
```

### Google Colab

Abre el cuaderno `notebooks/BC10_colab.ipynb` en Google Colab. El cuaderno descarga automáticamente el paquete starter.
