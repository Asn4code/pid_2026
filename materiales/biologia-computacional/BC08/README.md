...
tar -xzf paquete/BC08_starter_v0.1.0.tar.gz
cd BC08_starter
```

### Google Colab

Abre el cuaderno `notebooks/BC08_colab.ipynb` en Google Colab. El cuaderno descarga automáticamente el paquete starter.
