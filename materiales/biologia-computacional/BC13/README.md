...
tar -xzf paquete/BC13_starter_v0.1.0.tar.gz
cd BC13_starter
```

### Google Colab

Abre el cuaderno `notebooks/BC13_colab.ipynb` en Google Colab. El cuaderno descarga automáticamente el paquete starter.
