...
tar -xzf paquete/BC09_starter_v0.1.0.tar.gz
cd BC09_starter
```

### Google Colab

Abre el cuaderno `notebooks/BC09_colab.ipynb` en Google Colab. El cuaderno descarga automáticamente el paquete starter.
