...
tar -xzf paquete/BC11_starter_v0.1.0.tar.gz
cd BC11_starter
```

### Google Colab

Abre el cuaderno `notebooks/BC11_colab.ipynb` en Google Colab. El cuaderno descarga automáticamente el paquete starter.
