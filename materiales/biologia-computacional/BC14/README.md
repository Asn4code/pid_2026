...
tar -xzf paquete/BC14_starter_v0.1.0.tar.gz
cd BC14_starter
```

### Google Colab

Abre el cuaderno `notebooks/BC14_colab.ipynb` en Google Colab. El cuaderno descarga automáticamente el paquete starter.
