...
tar -xzf paquete/BC07_starter_v0.1.0.tar.gz
cd BC07_starter
```

### Google Colab

Abre el cuaderno `notebooks/BC07_colab.ipynb` en Google Colab. El cuaderno descarga automáticamente el paquete starter.
