...
tar -xzf paquete/BC12_starter_v0.1.0.tar.gz
cd BC12_starter
```

### Google Colab

Abre el cuaderno `notebooks/BC12_colab.ipynb` en Google Colab. El cuaderno descarga automáticamente el paquete starter.
