...
tar -xzf paquete/BC04_starter_v0.1.0.tar.gz
cd BC04_starter
```

### Google Colab

Abre el cuaderno `notebooks/BC04_colab.ipynb` en Google Colab. El cuaderno descarga automáticamente el paquete starter.
