# Técnicas Computacionales en Biología — TC06
...
tar -xzf paquete/TC06_starter_v0.1.0.tar.gz
cd TC06_starter
```

### Google Colab

Abre el cuaderno `notebooks/TC06_colab.ipynb` en Google Colab. El cuaderno descarga automáticamente el paquete starter.
