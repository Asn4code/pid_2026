# Técnicas Computacionales en Biología — TC08
...
tar -xzf paquete/TC08_starter_v0.1.0.tar.gz
cd TC08_starter
```

### Google Colab

Abre el cuaderno `notebooks/TC08_colab.ipynb` en Google Colab. El cuaderno descarga automáticamente el paquete starter.
