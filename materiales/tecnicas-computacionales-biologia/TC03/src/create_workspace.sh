#!/usr/bin/env bash
# Crea el espacio de trabajo del anexo de TC-CH03. Solo carpetas, la
# herramienta de cómputo y una tabla de respuestas con la cabecera.
# Uso: practice_assets/create_workspace.sh [DESTINO]   (por defecto TC03_entrega)
set -euo pipefail
DEST="${1:-TC03_entrega}"
...
printf 'fragmento\tveredicto_ia\torden_real\tjustificacion\n' > "$DEST/notas/respuestas.tsv"
