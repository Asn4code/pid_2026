...
cp -- "$practice_dir/datos/caso_estructura.txt" "$destination/datos/"
cp -- "$practice_dir/datos/caso_ids.txt" "$destination/datos/"
...
printf 'Datos: 1 secuencia, 3 estructuras punto-paréntesis y 1 lista de lecturas\n'
printf 'TC04_STARTER_OK\n'
