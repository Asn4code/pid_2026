# Técnicas Computacionales en Biología — TC09
...
tar -xzf paquete/TC09_starter_v0.1.0.tar.gz
cd TC09_starter
```

### Google Colab

Abre el cuaderno `notebooks/TC09_colab.ipynb` en Google Colab. El cuaderno descarga automáticamente el paquete starter.
